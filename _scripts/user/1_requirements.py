...
# 配置文件路径
CONFIG_FILE = '.config/pyenv.json'
SOURCES_FILE = '.config/py_requirements_sources.json'
# 默认配置
DEFAULT_CONFIG = {
    "import2pip": {
    ...
    "import_ignore_file": ["setup.py", "__init__.py", "0_venv.py", "1_requirements.py", "2_install_import.py", "mypackager.py"],
    "import_src": []
}
